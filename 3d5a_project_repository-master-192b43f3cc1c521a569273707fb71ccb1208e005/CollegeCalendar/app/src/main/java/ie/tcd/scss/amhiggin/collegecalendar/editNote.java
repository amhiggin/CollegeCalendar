...
public class editNote extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String message = noteIntent.getStringExtra(ViewTimetable.MESSAGE_KEY);

        noteFile = "myNotes";

        EditText timeBox = (EditText) findViewById(R.id.timeBox);
        if(message.equals(getString(R.string.noNoteEntered)))
        {
            //Do nothing
        }
        else
    ...
    public void saveEventButton(View view) {
        ...
        if(message.equals(""))
            message = getString(R.string.noNoteEntered);
        message = message + END_OF_EVENT;

        populateTimetable_noLineBreaks(noteFile);
    ...
    public void populateTimetable_noLineBreaks(final String selected_date)
    {
        ...
        noteFileName = selected_date + ".txt";
